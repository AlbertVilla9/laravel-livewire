      ...
      <div class="lg:w-1/2 xl:max-w-screen-sm">
        ...
        >
          <div class="cursor-pointer flex items-center">
            <div>
              <img src="https://icon-library.com/images/obi-wan-kenobi-icon/obi-wan-kenobi-icon-4.jpg" alt="obi">
                <style type="text/css">
                  .st0 {
                    fill: none;
                    stroke: currentColor;
    ...
    >
      ...
      >
        ...
        <p>
          ...
          <span class="font-bold">free</span> TailwindCSS Component Kit built
          with React.
        </p>
        <p class="mt-2">
